...
public class LengthStmtLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"KEEP", "COMPRESS", "YES", "DEFAULT", "Informat", "DOLLAR", "EQ", "NE", 
			...
			"ESC", "INT", "FloatingPointLiteral", "Identifier", "ALL", "DOT", "AT", 
			"EQUAL", "COMMA", "LBracket", "RBracket", "A", "B", "C", "D", "E", "F", 
	...
	public LengthStmtLexer(CharStream input) {
		super(input);
