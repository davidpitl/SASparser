...
public class FreeSASLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "ABEND", "END", "LENGTH", "QKUPCASE", 
			...
			"X", "Y", "Z", "WS", "COMMENT", "LINE_COMMENT", "LLBracket", "RRBracket", 
			"SELECT", "DISTINCT", "UNIQUE", "FROM", "AS", "WHERE", "GROUP", "HAVING", 
			"ORDER", "ASC", "DESC", "ADD", "CONSTRAINT", "FOREIGN", "KEY", "PRIMARY", 
			"MODIFY"
		};
	}
	...
	public FreeSASLexer(CharStream input) {
		super(input);
