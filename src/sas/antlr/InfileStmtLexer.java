...
public class InfileStmtLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"KEEP", "COMPRESS", "YES", "Informat", "DOLLAR", "EQ", "NE", "GT", "LT", 
			"GE", "LE", "IN", "EQC", "NEC", "GTC", "LTC", "GEC", "LEC", "INColon", 
			"AND", "OR", "NOT", "MIN", "MAX", "DateLiteral", "TimeLiteral", "DateTimeLiteral", 
			"BitLiteral", "NameLiteral", "HexLiteral", "STRINGLITERAL", "ESC", "INT", 
			"FloatingPointLiteral", "Identifier", "ALL", "DOT", "AT", "EQUAL", "COMMA", 
			"LBracket", "RBracket", "A", "B", "C", "D", "E", "F", "G", "H", "I", 
	...
	public InfileStmtLexer(CharStream input) {
		super(input);
